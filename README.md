...
**SDE2 @ Barclays** — backend systems, distributed services, and AI agents. Active open-source contributor ([VS Code](https://github.com/microsoft/vscode), [Kubernetes](https://github.com/kubernetes/kubernetes)).
...
| **Open source** | Deep product contributions (VS Code UX), plus Kubernetes, Playwright, Appwrite, Airflow |
